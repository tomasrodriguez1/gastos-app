...
- Reservas de ahorro F6 (`GET/POST /api/reservas`, `PATCH /api/reservas/:id`, `GET /api/reservas/:id/saldos`) — bolsillos externos (Mercado Pago); el agente las crea/edita/lista además de registrar saldos
- Catálogos CRUD
