      ...
      <div className="flex flex-wrap gap-3 items-center">
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            className="bg-slate-700 border border-slate-600 rounded-lg px-3 py-1.5 text-sm text-slate-200 placeholder-slate-500 outline-none focus:border-sky-500 w-52"
          />
        </div>
